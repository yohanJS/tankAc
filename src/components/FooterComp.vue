<template>
    ...
    <div class="row">
      ...
      <div class="col-12 mt-5 d-flex justify-content-center" style="border-top: 1px solid #ffffff45;">
        ...
        <a href="https://www.facebook.com/profile.php?id=100063482024899" class="nav-link m-2" aria-label="Facebook Logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-facebook"
            viewBox="0 0 16 16">
            <path
        ...
        <a href="#" class="nav-link m-2" aria-label="Instagram Logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-instagram"
            viewBox="0 0 16 16">
            <path
        ...
        <a href="#" class="nav-link m-2" aria-label="Twitter Logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-twitter-x"
            viewBox="0 0 16 16">
            <path
